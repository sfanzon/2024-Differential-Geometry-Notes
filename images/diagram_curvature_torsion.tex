...
\begin{tikzpicture}
	...
	\node (warning) [rectblocklarge, below right of=gamma, xshift=-2.8cm, yshift = -5.7cm] {\textcolor{magenta}{Warning} \\ \vspace{0.2cm} $\kappa$ only defined for regular $\boldsymbol{\gamma}$ \\ \vspace{0.2cm} $\tau$ only defined for regular $\boldsymbol{\gamma}$ with $\kappa \neq 0$};
