...
\tg := \g  \circ s^{-1}
$$
with $s^{-1}$ inverse of the arc-length of $\g$.
...
s = s(t)
$$
and the parameter of the inverse $\psi := s^{-1}$ of the arc-lenght is $s$
$$
\psi = \psi(s)
$$
...
the unit speed reparametrization.
...
function. By Proposition \ref{proposition-arc-length-unit}
$$
\tg := \g \circ s^{-1}
$$
is a unit speed reparametrization of $\g$. According to the above notations, we will write
$$
