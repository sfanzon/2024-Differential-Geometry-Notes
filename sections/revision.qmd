...
### Arc-length reparametrization of the Circle
 ...
 Let $\g \colon (0,2\pi) \to \R^2$ be the circle
...
Consider again the curve from Example \ref{example-curvature}
$$
...
Let $\g \colon \R \to \R^3$ be the curve defined by
$$
\g(t) = (t,t^2,t^3 ) \,.
$$
...
Consider the function $f \colon \R^2 \to \R^2$ defined by
$$
...
Let $\mathbf{a}, \pp, \mathbf{q} \in \R^3$, with $\pp$ and $\mathbf{q}$ orthonormal. The plane
$$
...
The catenary function is defined by
$$
f(v) = \cosh (v) \,.  
$$
...
Let $\mathbf{a}, \pp, \mathbf{q} \in \R^3$, with $\pp$ and $\mathbf{q}$ orthonormal. Consider the plane with chart
$$
