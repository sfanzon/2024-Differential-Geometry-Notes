...
1. Make sure you are very comfortable with the Definitions, Theorems, Proofs, and Examples contained in this Revision Guide.
...
Find the first fundamental form of the surface chart
$$
...
1. We have already computed in Example \ref{example-fff-cone-bis}, that the first fundamental form of $\sss$ is
$$
